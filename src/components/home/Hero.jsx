    ...
    <section ref={containerRef} className="relative min-h-screen flex items-center overflow-hidden pt-20">
      ...
      <div className="relative max-w-7xl mx-auto px-6 w-full">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <motion.div
            className="relative flex items-center justify-center order-1 lg:order-2 pe-4 lg:pe-0"
            initial={{ opacity: 0, scale: 0.9 }}
            animate={{ opacity: 1, scale: 0.9 }}
            transition={{ duration: 1, delay: 0.4, ease: [0.25, 0.46, 0.45, 0.94] }}
          >
            <div className="relative w-[360px] h-[470px] sm:w-[430px] sm:h-[550px] md:w-[500px] md:h-[620px]">
              <div
                className="absolute -inset-6 rounded-premium blur-xl animate-pulse"
                style={{
                  background: 'linear-gradient(to top right, #22d3ee, #6366f1, #ec4899)',
                  opacity: 0.2,
                }}
              />
              <div
              ...
              >
                ...
                >
                  <motion.img
                    ...
                    // style={{
                    //   // filter: 'drop-shadow(0 0 30px rgba(0,120,250,0.20))',
                    //   background: '#071821'
                    // }}
                    animate={{ y: [0, -8, 0] }}
                    transition={{
